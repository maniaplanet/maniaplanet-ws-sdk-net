...
{
    public class ManialinkPublisher : Client
    {
        protected string _manialink;

        public ManialinkPublisher(string username, string password, string manialink = null)
